document.addEventListener("DOMContentLoaded", function () {
  ...
  // Actualizar el enlace del botón cuando se cambia el distrito
  districtSelect.addEventListener("change", function () {
    const selectedDistrict = this.value;
    if (selectedDistrict) {
      viewGraphButton.style.display = "block";
      // Formato de URL correcto según tu configuración
      viewGraphButton.href = `/grafo_${selectedDistrict}/`;
      viewGraphButton.target = "_blank";
    } else {
      viewGraphButton.style.display = "none";
    }
  });
